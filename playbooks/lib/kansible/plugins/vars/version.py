...
if not ge(LooseVersion(__version__), LooseVersion(version_requirement)):
    raise AnsibleError(('KS Docker Symfony no longer supports Ansible {}.\n'
    ...
    display.warning(u'You Ansible version is {} but this version of KS Docker Symfony has only been tested for '
            u'compatability with Ansible {} -> {}. It is advisable to check for KS Docker Symfony updates or '
